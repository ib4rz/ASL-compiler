...
public:
  ...
  void incompatibleArgument         (antlr4::tree::TerminalNode *node);
  ...
  void incompatibleOperator         (antlr4::tree::TerminalNode *node);
  ...
  void nonIntegerBucleControl       (antlr4::tree::TerminalNode *node);
  ...
  void numberOfArguments            (antlr4::tree::TerminalNode *node);
  void incorrectNumber            (antlr4::tree::TerminalNode *node);
