...
public:
  ...
  virtual antlrcpp::Any visitPair_type(AslParser::Pair_typeContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual antlrcpp::Any visitElseStat(AslParser::ElseStatContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual antlrcpp::Any visitFilter(AslParser::FilterContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual antlrcpp::Any visitSumExpr(AslParser::SumExprContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual antlrcpp::Any visitMaximum(AslParser::MaximumContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual antlrcpp::Any visitPairExpr(AslParser::PairExprContext *ctx) override {
    return visitChildren(ctx);
  }
