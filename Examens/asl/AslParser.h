...
public:
  enum {
    ...
    CHAR = 29, ARRAY = 30, PAIR = 31, EDNPAIR = 32, IF = 33, THEN = 34, 
    ELSE = 35, ENDIF = 36, WHILE = 37, DO = 38, ENDWHILE = 39, FOR = 40, 
    INRANGE = 41, ENDFOR = 42, FUNC = 43, ENDFUNC = 44, RET = 45, READ = 46, 
    WRITE = 47, MAX = 48, SUM = 49, FILTER = 50, INTO = 51, USING = 52, 
    FIRST = 53, SECOND = 54, INTVAL = 55, BOOLVAL = 56, FLOATVAL = 57, CHARVAL = 58, 
    ID = 59, STRING = 60, COMMENT = 61, WS = 62
  };

  enum {
    RuleProgram = 0, RuleFunction = 1, RuleParameters = 2, RuleDeclarations = 3, 
    RuleArray_decl = 4, RuleVariable_decl = 5, RuleType = 6, RulePair_type = 7, 
    RuleBasic_type = 8, RuleStatements = 9, RuleStatement = 10, RuleLeft_expr = 11, 
    RuleElseStat = 12, RuleExpr = 13, RuleIdent = 14
  };
  ...
  class  Pair_typeContext : public antlr4::ParserRuleContext {
  public:
    Pair_typeContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *PAIR();
    std::vector<Basic_typeContext *> basic_type();
    Basic_typeContext* basic_type(size_t i);
    antlr4::tree::TerminalNode *EDNPAIR();
  ...
  class  RetStmtContext : public StatementContext {
  public:
    RetStmtContext(StatementContext *ctx);
  ...
  class  IndexerContext : public ExprContext {
  public:
    IndexerContext(ExprContext *ctx);
  ...
  class  SumExprContext : public ExprContext {
  public:
    SumExprContext(ExprContext *ctx);
  ...
  class  MaximumContext : public ExprContext {
  public:
    MaximumContext(ExprContext *ctx);
