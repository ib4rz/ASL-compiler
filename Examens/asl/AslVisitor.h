...
public:
   ...
   */
    ...
    virtual antlrcpp::Any visitPair_type(AslParser::Pair_typeContext *context) = 0;
    ...
    virtual antlrcpp::Any visitElseStat(AslParser::ElseStatContext *context) = 0;

    virtual antlrcpp::Any visitFunctional(AslParser::FunctionalContext *context) = 0;
    ...
    virtual antlrcpp::Any visitFilter(AslParser::FilterContext *context) = 0;

    virtual antlrcpp::Any visitSumExpr(AslParser::SumExprContext *context) = 0;

    virtual antlrcpp::Any visitMaximum(AslParser::MaximumContext *context) = 0;
    ...
    virtual antlrcpp::Any visitPairExpr(AslParser::PairExprContext *context) = 0;
